            ...
            var source =
                    {
                        ...
                        url: "<?php echo url_for('sello_editorial/indexajax') ?>",
...
<div class="jumbotron">
<h2>Listado de Sellos Editoriales</h2>
<br>
...
<table width="100%">
    ...
    <tr>
        <td><?php echo link_to(image_tag('add.png'),'sello_editorial/new',array('title' => 'Agregar'))?></td>
    </tr>
</table>
</div>