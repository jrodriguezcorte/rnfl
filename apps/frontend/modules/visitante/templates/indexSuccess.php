            ...
            var source =
                    {
                        ...
                        url: "<?php echo url_for('visitante/indexajax?id_feria='.$sf_params->get('id_feria')) ?>",
            ...
            $("#jqxgrid").jqxGrid(
                    {
                        ...
                        theme: 'ui-redmond',
                        columns: [
                            {text: 'Fecha', datafield: 'Fecha', cellsformat: 'dd-MM-yyyy' ,cellsalign: 'center' },
...
?>
<h2>Listado de Visitantes asociadas a la feria <?php echo $Feria->getNombre() ?></h2>
<br>
...
<table width="100%">
    ...
    <tr>
        <td><?php echo link_to(image_tag('add.png'),"visitante/new?id_feria=$id_feria",array('title' => 'Agregar'))?></td>
    </tr>
</table>
</div>