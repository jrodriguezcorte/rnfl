            ...
            var source =
                    {
                        ...
                        url: "<?php echo url_for('usuario/indexajax') ?>",
            ...
            $("#jqxgrid").jqxGrid(
                    {
                        ...
                        theme: 'ui-redmond',
                        columns: [
                            {text: 'Nombre', datafield: 'Nombre', width: 220  },
                            {text: 'Apellido', datafield: 'Apellido', width: 220  },
                            {text: 'Login', datafield: 'Login', width: 220  },
                            {text: 'Correo', datafield: 'Correo', width: 220  },
