...
<div class="alert feria-registro" role="alert">
    <h4>Sección de registro asociado a la feria  <b><?php echo $Feria->getNombre(); ?></b></h4>
</div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
                  <li><?php echo link_to("Agregar", "expositor/new?id_feria=$id_feria")  ?></li>
                  <li><?php echo link_to("Listado", "expositor/index?id_feria=$id_feria")  ?></li>                    
                  <li><?php echo link_to("Asociar expositor a la Feria", "expositor_feria/new?id_feria=$id_feria")  ?></li>
                  <li><?php echo link_to("Listado de expositores de la Feria", "expositor_feria/index?id_feria=$id_feria")  ?></li>          </ul>
        </li>
        <li class="dropdown">
