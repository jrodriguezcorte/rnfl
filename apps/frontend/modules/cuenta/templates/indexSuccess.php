...
?>
<h2>Listado de Cuentas asociadas a la feria <?php echo $Feria->getNombre() ?></h2>
<br>
...
<table width="100%">
    ...
    <tr>
        <td><?php echo link_to(image_tag('add.png'),"cuenta/new?id_feria=$id_feria",array('title' => 'Agregar'))?></td>
    </tr>
</table>
</div>