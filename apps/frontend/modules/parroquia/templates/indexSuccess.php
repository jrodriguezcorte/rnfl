            ...
            var source =
                    {
                        ...
                        url: "<?php echo url_for('parroquia/indexajax') ?>",
            ...
            $("#jqxgrid").jqxGrid(
                    {
                        ...
                        columns: [
                            ...
                            {text: 'País', datafield: 'Pais', width: 200 ,cellsalign: 'center'},
                            {text: 'Estado', datafield: 'Estado', width: 200 ,cellsalign: 'center'},
                            {text: 'Municipio', datafield: 'Municipio', width: 200 ,cellsalign: 'center'},
...
<table width="100%">
    ...
    <tr>
        <td><?php echo link_to(image_tag('add.png'),'parroquia/new',array('title' => 'Agregar'))?></td>
    </tr>
</table>
</div>
