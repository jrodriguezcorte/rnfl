...
abstract class BaseRegion extends BaseObject  implements Persistent
{
	...
	public function setNombre($v)
	{
		...
		if ($this->nombre !== $v) {
			$this->nombre = $v;
			$this->modifiedColumns[] = RegionPeer::NOMBRE;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RegionPeer::NOMBRE)) $criteria->add(RegionPeer::NOMBRE, $this->nombre);
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseRegion:' . $name))
		{
