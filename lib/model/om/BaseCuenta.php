...
abstract class BaseCuenta extends BaseObject  implements Persistent
{
	...
	public function setActivo($v)
	{
		...
		if ($this->activo !== $v || $this->isNew()) {
			$this->activo = $v;
			$this->modifiedColumns[] = CuentaPeer::ACTIVO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 8; // 8 = CuentaPeer::NUM_HYDRATE_COLUMNS.
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CuentaPeer::ACTIVO)) $criteria->add(CuentaPeer::ACTIVO, $this->activo);
