...
/**
 * Base class that represents a row from the 'sello_editorial' table.
 *
 * 
 *
 ...
 */
abstract class BaseSelloEditorial extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'SelloEditorialPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        SelloEditorialPeer
	 */
	 ...
	 * @return     SelloEditorial The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = SelloEditorialPeer::ID;
		}
	...
	public function setNombre($v)
	{
		...
		if ($this->nombre !== $v) {
			$this->nombre = $v;
			$this->modifiedColumns[] = SelloEditorialPeer::NOMBRE;
		}
	...
	public function setIdPais($v)
	{
		...
		if ($this->id_pais !== $v) {
			$this->id_pais = $v;
			$this->modifiedColumns[] = SelloEditorialPeer::ID_PAIS;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = SelloEditorialPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating SelloEditorial object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = SelloEditorialPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseSelloEditorial:delete:pre') as $callable)
			{
			...
			if ($ret) {
				SelloEditorialQuery::create()
					->filterByPrimaryKey($this->getPrimaryKey())
					->delete($con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseSelloEditorial:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseSelloEditorial:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseSelloEditorial:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				SelloEditorialPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(SelloEditorialPeer::ID) ) {
					...
					$affectedRows += SelloEditorialPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = SelloEditorialPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = SelloEditorialPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['SelloEditorial'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['SelloEditorial'][$this->getPrimaryKey()] = true;
		$keys = SelloEditorialPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SelloEditorialPeer::ID)) $criteria->add(SelloEditorialPeer::ID, $this->id);
		if ($this->isColumnModified(SelloEditorialPeer::NOMBRE)) $criteria->add(SelloEditorialPeer::NOMBRE, $this->nombre);
		if ($this->isColumnModified(SelloEditorialPeer::ID_PAIS)) $criteria->add(SelloEditorialPeer::ID_PAIS, $this->id_pais);
	...
	{
		$criteria = new Criteria(SelloEditorialPeer::DATABASE_NAME);
		$criteria->add(SelloEditorialPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of SelloEditorial (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     SelloEditorial Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     SelloEditorialPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new SelloEditorialPeer();
		}
		return self::$peer;
	}
	...
	public function getPais(PropelPDO $con = null)
	{
		if ($this->aPais === null && ($this->id_pais !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aPais->addSelloEditorials($this);
			 */
		}
		return $this->aPais;
	}
	 ...
	 * If this SelloEditorial is new, it will return
	 ...
	 * Otherwise if this SelloEditorial is new, it will return
	 * an empty collection; or if this SelloEditorial has previously
	 * been saved, it will retrieve related ExpositorSelloeditorials from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in SelloEditorial.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 ...
	 * @return     PropelCollection|array ExpositorSelloeditorial[] List of ExpositorSelloeditorial objects
	 */
	public function getExpositorSelloeditorialsJoinFeria($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = ExpositorSelloeditorialQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array FeriaSelloeditorial[] List of FeriaSelloeditorial objects
	 */
	public function getFeriaSelloeditorialsJoinFeria($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = FeriaSelloeditorialQuery::create(null, $criteria);
		$query->joinWith('Feria', $join_behavior);
	...
	{
		return (string) $this->exportTo(SelloEditorialPeer::DEFAULT_STRING_FORMAT);
	}
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseSelloEditorial:' . $name))
		{
