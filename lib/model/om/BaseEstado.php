...
abstract class BaseEstado extends BaseObject  implements Persistent
{
	...
	public function setIdPais($v)
	{
		...
		if ($this->id_pais !== $v) {
			$this->id_pais = $v;
			$this->modifiedColumns[] = EstadoPeer::ID_PAIS;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_pais = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->resetModified();
			...
			return $startcol + 3; // 3 = EstadoPeer::NUM_HYDRATE_COLUMNS.
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setIdPais($arr[$keys[2]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EstadoPeer::ID_PAIS)) $criteria->add(EstadoPeer::ID_PAIS, $this->id_pais);
