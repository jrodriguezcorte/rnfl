 ...
 * @method     ActividadFinalizadaQuery orderByActivo($order = Criteria::ASC) Order by the activo column
 *
 ...
 * @method     ActividadFinalizadaQuery groupByActivo() Group by the activo column
 *
 ...
 * @method     ActividadFinalizada findOneByActivo(boolean $activo) Return the first ActividadFinalizada filtered by the activo column
 *
 ...
 * @method     array findByActivo(boolean $activo) Return ActividadFinalizada objects filtered by the activo column
 *
...
abstract class BaseActividadFinalizadaQuery extends ModelCriteria
{
	...
	public function filterByActivo($activo = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(ActividadFinalizadaPeer::ACTIVO, $activo, $comparison);
	}
