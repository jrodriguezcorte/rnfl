...
abstract class BaseCuentaPeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'IdBanco', 'Swift', 'Aba', 'Beneficiario', 'IdFeria', 'Numero', 'Activo', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'idBanco', 'swift', 'aba', 'beneficiario', 'idFeria', 'numero', 'activo', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ID_BANCO, self::SWIFT, self::ABA, self::BENEFICIARIO, self::ID_FERIA, self::NUMERO, self::ACTIVO, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'ID_BANCO', 'SWIFT', 'ABA', 'BENEFICIARIO', 'ID_FERIA', 'NUMERO', 'ACTIVO', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'id_banco', 'swift', 'aba', 'beneficiario', 'id_feria', 'numero', 'activo', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'IdBanco' => 1, 'Swift' => 2, 'Aba' => 3, 'Beneficiario' => 4, 'IdFeria' => 5, 'Numero' => 6, 'Activo' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'idBanco' => 1, 'swift' => 2, 'aba' => 3, 'beneficiario' => 4, 'idFeria' => 5, 'numero' => 6, 'activo' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ID_BANCO => 1, self::SWIFT => 2, self::ABA => 3, self::BENEFICIARIO => 4, self::ID_FERIA => 5, self::NUMERO => 6, self::ACTIVO => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'ID_BANCO' => 1, 'SWIFT' => 2, 'ABA' => 3, 'BENEFICIARIO' => 4, 'ID_FERIA' => 5, 'NUMERO' => 6, 'ACTIVO' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'id_banco' => 1, 'swift' => 2, 'aba' => 3, 'beneficiario' => 4, 'id_feria' => 5, 'numero' => 6, 'activo' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(CuentaPeer::ACTIVO);
		} else {
