...
/**
 * Base class that represents a row from the 'linea_editorial' table.
 *
 * 
 *
 ...
 */
abstract class BaseLineaEditorial extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'LineaEditorialPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        LineaEditorialPeer
	 */
	 ...
	 * @return     LineaEditorial The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = LineaEditorialPeer::ID;
		}
	...
	public function setNombre($v)
	{
		...
		if ($this->nombre !== $v) {
			$this->nombre = $v;
			$this->modifiedColumns[] = LineaEditorialPeer::NOMBRE;
		}
	...
	public function setObservaciones($v)
	{
		...
		if ($this->observaciones !== $v) {
			...
			$this->modifiedColumns[] = LineaEditorialPeer::OBSERVACIONES;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = LineaEditorialPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating LineaEditorial object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = LineaEditorialPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseLineaEditorial:delete:pre') as $callable)
			{
			...
			if ($ret) {
				LineaEditorialQuery::create()
					->filterByPrimaryKey($this->getPrimaryKey())
					->delete($con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseLineaEditorial:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseLineaEditorial:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseLineaEditorial:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				LineaEditorialPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(LineaEditorialPeer::ID) ) {
					...
					$affectedRows = LineaEditorialPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = LineaEditorialPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = LineaEditorialPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['LineaEditorial'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['LineaEditorial'][$this->getPrimaryKey()] = true;
		$keys = LineaEditorialPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LineaEditorialPeer::ID)) $criteria->add(LineaEditorialPeer::ID, $this->id);
		if ($this->isColumnModified(LineaEditorialPeer::NOMBRE)) $criteria->add(LineaEditorialPeer::NOMBRE, $this->nombre);
		if ($this->isColumnModified(LineaEditorialPeer::OBSERVACIONES)) $criteria->add(LineaEditorialPeer::OBSERVACIONES, $this->observaciones);
	...
	{
		$criteria = new Criteria(LineaEditorialPeer::DATABASE_NAME);
		$criteria->add(LineaEditorialPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of LineaEditorial (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     LineaEditorial Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     LineaEditorialPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new LineaEditorialPeer();
		}
		return self::$peer;
	}
	 ...
	 * If this LineaEditorial is new, it will return
	 ...
	 * Otherwise if this LineaEditorial is new, it will return
	 * an empty collection; or if this LineaEditorial has previously
	 * been saved, it will retrieve related LineaEditorialExposiorFerias from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in LineaEditorial.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 ...
	 * @return     PropelCollection|array LineaEditorialExposiorFeria[] List of LineaEditorialExposiorFeria objects
	 */
	public function getLineaEditorialExposiorFeriasJoinExpositorFeria($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = LineaEditorialExposiorFeriaQuery::create(null, $criteria);
	...
	{
		return (string) $this->exportTo(LineaEditorialPeer::DEFAULT_STRING_FORMAT);
	}
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseLineaEditorial:' . $name))
		{
