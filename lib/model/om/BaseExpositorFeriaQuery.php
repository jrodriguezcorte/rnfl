 ...
 * @method     ExpositorFeriaQuery orderByProcedencia($order = Criteria::ASC) Order by the procedencia column
 ...
 * @method     ExpositorFeriaQuery orderByRepresentanteLegal($order = Criteria::ASC) Order by the representante_legal column
 * @method     ExpositorFeriaQuery orderByNombreEjecutivoFeria($order = Criteria::ASC) Order by the nombre_ejecutivo_feria column
 * @method     ExpositorFeriaQuery orderByContacto($order = Criteria::ASC) Order by the contacto column
 * @method     ExpositorFeriaQuery orderByResponsableStand($order = Criteria::ASC) Order by the responsable_stand column
 * @method     ExpositorFeriaQuery orderByAtencionStand($order = Criteria::ASC) Order by the atencion_stand column
 ...
 * @method     ExpositorFeriaQuery groupByProcedencia() Group by the procedencia column
 ...
 * @method     ExpositorFeriaQuery groupByRepresentanteLegal() Group by the representante_legal column
 * @method     ExpositorFeriaQuery groupByNombreEjecutivoFeria() Group by the nombre_ejecutivo_feria column
 * @method     ExpositorFeriaQuery groupByContacto() Group by the contacto column
 * @method     ExpositorFeriaQuery groupByResponsableStand() Group by the responsable_stand column
 * @method     ExpositorFeriaQuery groupByAtencionStand() Group by the atencion_stand column
 ...
 * @method     ExpositorFeria findOneByProcedencia(boolean $procedencia) Return the first ExpositorFeria filtered by the procedencia column
 ...
 * @method     ExpositorFeria findOneByRepresentanteLegal(string $representante_legal) Return the first ExpositorFeria filtered by the representante_legal column
 ...
 * @method     ExpositorFeria findOneByContacto(string $contacto) Return the first ExpositorFeria filtered by the contacto column
 ...
 * @method     ExpositorFeria findOneByAtencionStand(string $atencion_stand) Return the first ExpositorFeria filtered by the atencion_stand column
 ...
 * @method     array findByProcedencia(boolean $procedencia) Return ExpositorFeria objects filtered by the procedencia column
 ...
 * @method     array findByRepresentanteLegal(string $representante_legal) Return ExpositorFeria objects filtered by the representante_legal column
 ...
 * @method     array findByContacto(string $contacto) Return ExpositorFeria objects filtered by the contacto column
 ...
 * @method     array findByAtencionStand(string $atencion_stand) Return ExpositorFeria objects filtered by the atencion_stand column
...
abstract class BaseExpositorFeriaQuery extends ModelCriteria
{
	 ...
	 * Example usage:
	 * <code>
	 * $query->filterByProcedencia(true); // WHERE procedencia = true
	 * $query->filterByProcedencia('yes'); // WHERE procedencia = true
	 * </code>
	 *
	 * @param     boolean|string $procedencia The value to use as filter.
	...
	public function filterByProcedencia($procedencia = null, $comparison = null)
	{
		if (is_string($procedencia)) {
			$procedencia = in_array(strtolower($procedencia), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
		}
		return $this->addUsingAlias(ExpositorFeriaPeer::PROCEDENCIA, $procedencia, $comparison);
	}
	...
	public function filterByRepresentanteLegal($representanteLegal = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(ExpositorFeriaPeer::REPRESENTANTE_LEGAL, $representanteLegal, $comparison);
	}
	...
	public function filterByContacto($contacto = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(ExpositorFeriaPeer::CONTACTO, $contacto, $comparison);
	}
	...
	/**
	 * Filter the query on the atencion_stand column
	 * 
	 * Example usage:
	 * <code>
	 * $query->filterByAtencionStand('fooValue');   // WHERE atencion_stand = 'fooValue'
	 * $query->filterByAtencionStand('%fooValue%'); // WHERE atencion_stand LIKE '%fooValue%'
	 * </code>
	 *
	 * @param     string $atencionStand The value to use as filter.
	 *              Accepts wildcards (* and % trigger a LIKE)
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    ExpositorFeriaQuery The current query, for fluid interface
	 */
	public function filterByAtencionStand($atencionStand = null, $comparison = null)
	{
		if (null === $comparison) {
			if (is_array($atencionStand)) {
				$comparison = Criteria::IN;
			} elseif (preg_match('/[\%\*]/', $atencionStand)) {
				$atencionStand = str_replace('*', '%', $atencionStand);
				$comparison = Criteria::LIKE;
			}
		}
		return $this->addUsingAlias(ExpositorFeriaPeer::ATENCION_STAND, $atencionStand, $comparison);
	}
