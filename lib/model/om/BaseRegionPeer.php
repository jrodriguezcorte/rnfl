...
abstract class BaseRegionPeer {
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(RegionPeer::NOMBRE);
		} else {
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseRegionPeer', $criteria, $con);
		}
	 ...
	 *
	 * @param      Region $value A Region object.
	...
	{
		return $withPrefix ? RegionPeer::CLASS_DEFAULT : RegionPeer::OM_CLASS;
	}
	...
	public static function doDeleteAll(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += RegionPeer::doOnDeleteCascade(new Criteria(RegionPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			$c = clone $criteria;
			$affectedRows += RegionPeer::doOnDeleteCascade($c, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(ActividadFinalizadaPeer::ID_REGION, $obj->getId());
			...
			$criteria->add(FeriaPeer::ID_REGION, $obj->getId());
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseRegionPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
