...
abstract class BasePonente extends BaseObject  implements Persistent
{
	...
	/**
	 * Initializes internal state of BasePonente object.
	 * @see        applyDefaults()
	 */
	...
	public function setActivo($v)
	{
		...
		if ($this->activo !== $v || $this->isNew()) {
			$this->activo = $v;
			$this->modifiedColumns[] = PonentePeer::ACTIVO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 12; // 12 = PonentePeer::NUM_HYDRATE_COLUMNS.
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PonentePeer::ACTIVO)) $criteria->add(PonentePeer::ACTIVO, $this->activo);
