 ...
 * @method     ExpositorQuery orderByIdUsuario($order = Criteria::ASC) Order by the id_usuario column
 * @method     ExpositorQuery orderByActivo($order = Criteria::ASC) Order by the activo column
 *
 ...
 * @method     ExpositorQuery groupByIdUsuario() Group by the id_usuario column
 * @method     ExpositorQuery groupByActivo() Group by the activo column
 *
 ...
 *
 * @method     ExpositorQuery leftJoinUsuario($relationAlias = null) Adds a LEFT JOIN clause to the query using the Usuario relation
 * @method     ExpositorQuery rightJoinUsuario($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Usuario relation
 * @method     ExpositorQuery innerJoinUsuario($relationAlias = null) Adds a INNER JOIN clause to the query using the Usuario relation
 *
 ...
 * @method     Expositor findOneByIdUsuario(int $id_usuario) Return the first Expositor filtered by the id_usuario column
 * @method     Expositor findOneByActivo(boolean $activo) Return the first Expositor filtered by the activo column
 *
 ...
 * @method     array findByIdUsuario(int $id_usuario) Return Expositor objects filtered by the id_usuario column
 * @method     array findByActivo(boolean $activo) Return Expositor objects filtered by the activo column
 *
...
abstract class BaseExpositorQuery extends ModelCriteria
{
	...
	public function filterByActivo($activo = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(ExpositorPeer::ACTIVO, $activo, $comparison);
	}
	...
	public function filterByUsuario($usuario, $comparison = null)
	{
		if ($usuario instanceof Usuario) {
			return $this
				->addUsingAlias(ExpositorPeer::ID_USUARIO, $usuario->getId(), $comparison);
		} elseif ($usuario instanceof PropelCollection) {
			if (null === $comparison) {
				$comparison = Criteria::IN;
			}
			return $this
				->addUsingAlias(ExpositorPeer::ID_USUARIO, $usuario->toKeyValue('PrimaryKey', 'Id'), $comparison);
		} else {
