 ...
 *
 * @method     ExpositorQuery leftJoinExpositorSelloeditorial($relationAlias = null) Adds a LEFT JOIN clause to the query using the ExpositorSelloeditorial relation
 * @method     ExpositorQuery rightJoinExpositorSelloeditorial($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ExpositorSelloeditorial relation
 * @method     ExpositorQuery innerJoinExpositorSelloeditorial($relationAlias = null) Adds a INNER JOIN clause to the query using the ExpositorSelloeditorial relation
 *
...
abstract class BaseExpositorQuery extends ModelCriteria
{
	...
	public function filterByExpositorSelloeditorial($expositorSelloeditorial, $comparison = null)
	{
		if ($expositorSelloeditorial instanceof ExpositorSelloeditorial) {
			return $this
				->addUsingAlias(ExpositorPeer::ID, $expositorSelloeditorial->getIdExpositor(), $comparison);
