...
abstract class BaseActividadFinalizada extends BaseObject  implements Persistent
{
	...
	public function setActivo($v)
	{
		...
		if ($this->activo !== $v || $this->isNew()) {
			$this->activo = $v;
			$this->modifiedColumns[] = ActividadFinalizadaPeer::ACTIVO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 21; // 21 = ActividadFinalizadaPeer::NUM_HYDRATE_COLUMNS.
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ActividadFinalizadaPeer::ACTIVO)) $criteria->add(ActividadFinalizadaPeer::ACTIVO, $this->activo);
