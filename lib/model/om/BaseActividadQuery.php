 ...
 * @method     ActividadQuery orderByDatosInstitucion($order = Criteria::ASC) Order by the datos_institucion column
 ...
 * @method     ActividadQuery orderByHoraSugerida($order = Criteria::ASC) Order by the hora_sugerida column
 * @method     ActividadQuery orderBySala($order = Criteria::ASC) Order by the sala column
 ...
 * @method     ActividadQuery groupByDatosInstitucion() Group by the datos_institucion column
 ...
 * @method     ActividadQuery groupByHoraSugerida() Group by the hora_sugerida column
 * @method     ActividadQuery groupBySala() Group by the sala column
 ...
 * @method     Actividad findOneByDatosInstitucion(string $datos_institucion) Return the first Actividad filtered by the datos_institucion column
 ...
 * @method     Actividad findOneByHoraSugerida(string $hora_sugerida) Return the first Actividad filtered by the hora_sugerida column
 * @method     Actividad findOneBySala(string $sala) Return the first Actividad filtered by the sala column
 ...
 * @method     array findByDatosInstitucion(string $datos_institucion) Return Actividad objects filtered by the datos_institucion column
 ...
 * @method     array findByHoraSugerida(string $hora_sugerida) Return Actividad objects filtered by the hora_sugerida column
 * @method     array findBySala(string $sala) Return Actividad objects filtered by the sala column
...
abstract class BaseActividadQuery extends ModelCriteria
{
	...
	/**
	 * Filter the query on the datos_institucion column
	 * 
	 * Example usage:
	 * <code>
	 * $query->filterByDatosInstitucion('fooValue');   // WHERE datos_institucion = 'fooValue'
	 * $query->filterByDatosInstitucion('%fooValue%'); // WHERE datos_institucion LIKE '%fooValue%'
	 * </code>
	 *
	 * @param     string $datosInstitucion The value to use as filter.
	 *              Accepts wildcards (* and % trigger a LIKE)
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    ActividadQuery The current query, for fluid interface
	 */
	public function filterByDatosInstitucion($datosInstitucion = null, $comparison = null)
	{
		if (null === $comparison) {
			if (is_array($datosInstitucion)) {
				$comparison = Criteria::IN;
			} elseif (preg_match('/[\%\*]/', $datosInstitucion)) {
				$datosInstitucion = str_replace('*', '%', $datosInstitucion);
				$comparison = Criteria::LIKE;
			}
		}
		return $this->addUsingAlias(ActividadPeer::DATOS_INSTITUCION, $datosInstitucion, $comparison);
	}
	...
	/**
	 * Filter the query on the hora_sugerida column
	 * 
	 * Example usage:
	 * <code>
	 * $query->filterByHoraSugerida('2011-03-14'); // WHERE hora_sugerida = '2011-03-14'
	 * $query->filterByHoraSugerida('now'); // WHERE hora_sugerida = '2011-03-14'
	 * $query->filterByHoraSugerida(array('max' => 'yesterday')); // WHERE hora_sugerida > '2011-03-13'
	 * </code>
	 *
	 * @param     mixed $horaSugerida The value to use as filter.
	 *              Values can be integers (unix timestamps), DateTime objects, or strings.
	 *              Empty strings are treated as NULL.
	 *              Use scalar values for equality.
	 *              Use array values for in_array() equivalent.
	 ...
	 * @return    ActividadQuery The current query, for fluid interface
	 */
	public function filterByHoraSugerida($horaSugerida = null, $comparison = null)
	{
		if (is_array($horaSugerida)) {
			$useMinMax = false;
			if (isset($horaSugerida['min'])) {
				$this->addUsingAlias(ActividadPeer::HORA_SUGERIDA, $horaSugerida['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($horaSugerida['max'])) {
				$this->addUsingAlias(ActividadPeer::HORA_SUGERIDA, $horaSugerida['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(ActividadPeer::HORA_SUGERIDA, $horaSugerida, $comparison);
	}

	/**
	 * Filter the query on the sala column
	 * 
	 * Example usage:
	 * <code>
	 * $query->filterBySala('fooValue');   // WHERE sala = 'fooValue'
	 * $query->filterBySala('%fooValue%'); // WHERE sala LIKE '%fooValue%'
	 * </code>
	 *
	 * @param     string $sala The value to use as filter.
	 *              Accepts wildcards (* and % trigger a LIKE)
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    ActividadQuery The current query, for fluid interface
	 */
	public function filterBySala($sala = null, $comparison = null)
	{
		if (null === $comparison) {
			if (is_array($sala)) {
				$comparison = Criteria::IN;
			} elseif (preg_match('/[\%\*]/', $sala)) {
				$sala = str_replace('*', '%', $sala);
				$comparison = Criteria::LIKE;
			}
		}
		return $this->addUsingAlias(ActividadPeer::SALA, $sala, $comparison);
	}
