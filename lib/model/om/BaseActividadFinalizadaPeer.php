...
abstract class BaseActividadFinalizadaPeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'IdActividad', 'IdFeria', 'NombreResponsable', 'FechaEjecucion', 'HoraEjecucion', 'HoraFinEjecucion', 'ParticipantesM', 'ParticipantesF', 'Total', 'EventoPublico', 'OtroIncumplimiento', 'NombreInstitucion', 'IdPais', 'IdEstado', 'IdMunicipio', 'IdParroquia', 'IdRegion', 'IncluirInfoGeografica', 'IdUsuario', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'idActividad', 'idFeria', 'nombreResponsable', 'fechaEjecucion', 'horaEjecucion', 'horaFinEjecucion', 'participantesM', 'participantesF', 'total', 'eventoPublico', 'otroIncumplimiento', 'nombreInstitucion', 'idPais', 'idEstado', 'idMunicipio', 'idParroquia', 'idRegion', 'incluirInfoGeografica', 'idUsuario', ),
