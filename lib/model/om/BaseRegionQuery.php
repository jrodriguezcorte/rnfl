 ...
 * @method     RegionQuery orderByNombre($order = Criteria::ASC) Order by the nombre column
 *
 * @method     RegionQuery groupById() Group by the id column
 * @method     RegionQuery groupByNombre() Group by the nombre column
 *
 ...
 *
 * @method     RegionQuery leftJoinActividadFinalizada($relationAlias = null) Adds a LEFT JOIN clause to the query using the ActividadFinalizada relation
 * @method     RegionQuery rightJoinActividadFinalizada($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ActividadFinalizada relation
 * @method     RegionQuery innerJoinActividadFinalizada($relationAlias = null) Adds a INNER JOIN clause to the query using the ActividadFinalizada relation
 *
 * @method     RegionQuery leftJoinFeria($relationAlias = null) Adds a LEFT JOIN clause to the query using the Feria relation
 * @method     RegionQuery rightJoinFeria($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Feria relation
 * @method     RegionQuery innerJoinFeria($relationAlias = null) Adds a INNER JOIN clause to the query using the Feria relation
 *
 ...
 * @method     Region findOneByNombre(string $nombre) Return the first Region filtered by the nombre column
 *
 * @method     array findById(int $id) Return Region objects filtered by the id column
 * @method     array findByNombre(string $nombre) Return Region objects filtered by the nombre column
 *
...
abstract class BaseRegionQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'propel', $modelName = 'Region', $modelAlias = null)
	{
	 ...
	 *
	 * @return    Region|array|mixed the result, formatted by the current formatter
	 */
	public function findPk($key, $con = null)
	{
		if ((null !== ($obj = RegionPeer::getInstanceFromPool((string) $key))) && $this->getFormatter()->isObjectFormatter()) {
	...
	public function filterByNombre($nombre = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(RegionPeer::NOMBRE, $nombre, $comparison);
	}
	...
	public function filterByActividadFinalizada($actividadFinalizada, $comparison = null)
	{
		if ($actividadFinalizada instanceof ActividadFinalizada) {
			return $this
				->addUsingAlias(RegionPeer::ID, $actividadFinalizada->getIdRegion(), $comparison);
	...
	public function filterByFeria($feria, $comparison = null)
	{
		if ($feria instanceof Feria) {
			return $this
				->addUsingAlias(RegionPeer::ID, $feria->getIdRegion(), $comparison);
