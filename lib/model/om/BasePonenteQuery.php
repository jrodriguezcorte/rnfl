 ...
 * @method     PonenteQuery orderByActivo($order = Criteria::ASC) Order by the activo column
 *
 ...
 * @method     PonenteQuery groupByActivo() Group by the activo column
 *
 ...
 * @method     Ponente findOneByActivo(boolean $activo) Return the first Ponente filtered by the activo column
 *
 ...
 * @method     array findByActivo(boolean $activo) Return Ponente objects filtered by the activo column
 *
...
abstract class BasePonenteQuery extends ModelCriteria
{
	...
	public function filterByActivo($activo = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(PonentePeer::ACTIVO, $activo, $comparison);
	}
