...
abstract class BaseStand extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the costo_bs field.
	 * @var        string
	 */
	protected $costo_bs;

	/**
	 * The value for the costo_ds field.
	 * @var        string
	 */
	protected $costo_ds;
	...
	/**
	 * Initializes internal state of BaseStand object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [costo_bs] column value.
	 * 
	 * @return     string
	 */
	public function getCostoBs()
	{
		return $this->costo_bs;
	}

	/**
	 * Get the [costo_ds] column value.
	 * 
	 * @return     string
	 */
	public function getCostoDs()
	{
		return $this->costo_ds;
	}
	...
	/**
	 * Set the value of [costo_bs] column.
	 * 
	 * @param      string $v new value
	 * @return     Stand The current object (for fluent API support)
	 */
	public function setCostoBs($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->costo_bs !== $v) {
			$this->costo_bs = $v;
			$this->modifiedColumns[] = StandPeer::COSTO_BS;
		}
	...
	/**
	 * Set the value of [costo_ds] column.
	 * 
	 * @param      string $v new value
	 * @return     Stand The current object (for fluent API support)
	 */
	public function setCostoDs($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->costo_ds !== $v) {
			$this->costo_ds = $v;
			$this->modifiedColumns[] = StandPeer::COSTO_DS;
		}
	...
	public function setActivo($v)
	{
		...
		if ($this->activo !== $v || $this->isNew()) {
			$this->activo = $v;
			$this->modifiedColumns[] = StandPeer::ACTIVO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->costo_bs = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->costo_ds = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			...
			return $startcol + 6; // 6 = StandPeer::NUM_HYDRATE_COLUMNS.
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 2:
				...
				break;
			case 3:
				return $this->getCostoBs();
				break;
			case 4:
				return $this->getCostoDs();
				break;
			case 5:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
	{
		...
		$result = array(
			...
			$keys[3] => $this->getCostoBs(),
			$keys[4] => $this->getCostoDs(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 2:
				...
				break;
			case 3:
				$this->setCostoBs($value);
				break;
			case 4:
				$this->setCostoDs($value);
				break;
			case 5:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setCostoBs($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setCostoDs($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(StandPeer::COSTO_BS)) $criteria->add(StandPeer::COSTO_BS, $this->costo_bs);
		if ($this->isColumnModified(StandPeer::COSTO_DS)) $criteria->add(StandPeer::COSTO_DS, $this->costo_ds);
		if ($this->isColumnModified(StandPeer::ACTIVO)) $criteria->add(StandPeer::ACTIVO, $this->activo);
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setCostoBs($this->getCostoBs());
		$copyObj->setCostoDs($this->getCostoDs());
