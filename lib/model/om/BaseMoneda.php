...
abstract class BaseMoneda extends BaseObject  implements Persistent
{
	...
	public function setNombre($v)
	{
		...
		if ($this->nombre !== $v) {
			$this->nombre = $v;
			$this->modifiedColumns[] = MonedaPeer::NOMBRE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = MonedaPeer::NUM_HYDRATE_COLUMNS.
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(MonedaPeer::ID) ) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MonedaPeer::NOMBRE)) $criteria->add(MonedaPeer::NOMBRE, $this->nombre);
	...
	{
		return (string) $this->exportTo(MonedaPeer::DEFAULT_STRING_FORMAT);
	}
