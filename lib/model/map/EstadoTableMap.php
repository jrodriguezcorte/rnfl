...
class EstadoTableMap extends TableMap
{
	...
	public function buildRelations()
	{
		...
		$this->addRelation('ActividadFinalizada', 'ActividadFinalizada', RelationMap::ONE_TO_MANY, array('id' => 'id_estado', ), null, null, 'ActividadFinalizadas');
		$this->addRelation('Feria', 'Feria', RelationMap::ONE_TO_MANY, array('id' => 'id_estado', ), null, null, 'Ferias');
		$this->addRelation('Municipio', 'Municipio', RelationMap::ONE_TO_MANY, array('id' => 'id_estado', ), null, null, 'Municipios');
	} // buildRelations()
