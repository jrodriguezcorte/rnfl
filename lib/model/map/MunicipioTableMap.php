...
class MunicipioTableMap extends TableMap
{
	...
	public function buildRelations()
	{
		...
		$this->addRelation('ActividadFinalizada', 'ActividadFinalizada', RelationMap::ONE_TO_MANY, array('id' => 'id_municipio', ), null, null, 'ActividadFinalizadas');
		$this->addRelation('Feria', 'Feria', RelationMap::ONE_TO_MANY, array('id' => 'id_municipio', ), null, null, 'Ferias');
		$this->addRelation('Parroquia', 'Parroquia', RelationMap::ONE_TO_MANY, array('id' => 'id_municipio', ), null, null, 'Parroquias');
	} // buildRelations()
