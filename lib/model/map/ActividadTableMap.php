...
class ActividadTableMap extends TableMap
{
	...
	public function buildRelations()
	{
		...
		$this->addRelation('TipoActividad', 'TipoActividad', RelationMap::MANY_TO_ONE, array('id_tipo_actividad' => 'id', ), null, null);
		$this->addRelation('ActividadFinalizada', 'ActividadFinalizada', RelationMap::ONE_TO_MANY, array('id' => 'id_actividad', ), null, null, 'ActividadFinalizadas');
		...
		$this->addRelation('IncumplmientoActividadFinalizada', 'IncumplmientoActividadFinalizada', RelationMap::ONE_TO_MANY, array('id' => 'id_actividad', ), null, null, 'IncumplmientoActividadFinalizadas');
