...
class FeriaTableMap extends TableMap
{
	...
	public function initialize()
	{
		...
		$this->addForeignKey('ID_STATUS_FERIA', 'IdStatusFeria', 'INTEGER', 'status_feria', 'ID', false, null, null);
		// validators
	} // initialize()
	...
	{
		$this->addRelation('TipoFeria', 'TipoFeria', RelationMap::MANY_TO_ONE, array('id_tipo_feria' => 'id', ), 'CASCADE', null);
		$this->addRelation('PaisRelatedByIdPaisHomenajeado', 'Pais', RelationMap::MANY_TO_ONE, array('id_pais_homenajeado' => 'id', ), 'CASCADE', null);
		$this->addRelation('PaisRelatedByIdPais', 'Pais', RelationMap::MANY_TO_ONE, array('id_pais' => 'id', ), 'CASCADE', null);
		...
		$this->addRelation('StatusFeria', 'StatusFeria', RelationMap::MANY_TO_ONE, array('id_status_feria' => 'id', ), null, null);
		$this->addRelation('Actividad', 'Actividad', RelationMap::ONE_TO_MANY, array('id' => 'id_feria', ), 'CASCADE', null, 'Actividads');
		$this->addRelation('ActividadFinalizada', 'ActividadFinalizada', RelationMap::ONE_TO_MANY, array('id' => 'id_feria', ), 'CASCADE', null, 'ActividadFinalizadas');
		$this->addRelation('Banco', 'Banco', RelationMap::ONE_TO_MANY, array('id' => 'id_feria', ), 'CASCADE', null, 'Bancos');
		$this->addRelation('Cuenta', 'Cuenta', RelationMap::ONE_TO_MANY, array('id' => 'id_feria', ), 'CASCADE', null, 'Cuentas');
		$this->addRelation('ExpositorFeria', 'ExpositorFeria', RelationMap::ONE_TO_MANY, array('id' => 'id_feria', ), 'CASCADE', null, 'ExpositorFerias');
		$this->addRelation('ExpositorLineaeditorial', 'ExpositorLineaeditorial', RelationMap::ONE_TO_MANY, array('id' => 'id_feria', ), 'CASCADE', null, 'ExpositorLineaeditorials');
		$this->addRelation('FeriaSelloeditorial', 'FeriaSelloeditorial', RelationMap::ONE_TO_MANY, array('id' => 'id_feria', ), 'CASCADE', null, 'FeriaSelloeditorials');
		$this->addRelation('IncumplmientoActividadFinalizada', 'IncumplmientoActividadFinalizada', RelationMap::ONE_TO_MANY, array('id' => 'id_feria', ), 'CASCADE', null, 'IncumplmientoActividadFinalizadas');
		$this->addRelation('PagoExpositor', 'PagoExpositor', RelationMap::ONE_TO_MANY, array('id' => 'id_feria', ), 'CASCADE', null, 'PagoExpositors');
		$this->addRelation('PonenteActividad', 'PonenteActividad', RelationMap::ONE_TO_MANY, array('id' => 'id_feria', ), 'CASCADE', null, 'PonenteActividads');
		$this->addRelation('Stand', 'Stand', RelationMap::ONE_TO_MANY, array('id' => 'id_feria', ), 'CASCADE', null, 'Stands');
		$this->addRelation('Status', 'Status', RelationMap::ONE_TO_MANY, array('id' => 'id_feria', ), 'CASCADE', null, 'Statuss');
		$this->addRelation('Visitante', 'Visitante', RelationMap::ONE_TO_MANY, array('id' => 'id_feria', ), 'CASCADE', null, 'Visitantes');
	} // buildRelations()
