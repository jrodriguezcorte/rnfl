...
class ParroquiaTableMap extends TableMap
{
	...
	public function buildRelations()
	{
		...
		$this->addRelation('ActividadFinalizada', 'ActividadFinalizada', RelationMap::ONE_TO_MANY, array('id' => 'id_parroquia', ), 'CASCADE', null, 'ActividadFinalizadas');
		$this->addRelation('Feria', 'Feria', RelationMap::ONE_TO_MANY, array('id' => 'id_parroquia', ), 'CASCADE', null, 'Ferias');
	} // buildRelations()
