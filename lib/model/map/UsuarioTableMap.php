...
class UsuarioTableMap extends TableMap
{
	...
	{
		$this->addRelation('Actividad', 'Actividad', RelationMap::ONE_TO_MANY, array('id' => 'id_usuario', ), null, null, 'Actividads');
		$this->addRelation('ActividadFinalizada', 'ActividadFinalizada', RelationMap::ONE_TO_MANY, array('id' => 'id_usuario', ), null, null, 'ActividadFinalizadas');
		$this->addRelation('ExpositorFeria', 'ExpositorFeria', RelationMap::ONE_TO_MANY, array('id' => 'id_usuario', ), null, null, 'ExpositorFerias');
		$this->addRelation('PagoExpositor', 'PagoExpositor', RelationMap::ONE_TO_MANY, array('id' => 'id_usuario', ), null, null, 'PagoExpositors');
	} // buildRelations()
