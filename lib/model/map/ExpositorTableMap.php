...
class ExpositorTableMap extends TableMap
{
	...
	public function buildRelations()
	{
		...
		$this->addRelation('ExpositorFeria', 'ExpositorFeria', RelationMap::ONE_TO_MANY, array('id' => 'id_expositor', ), null, null, 'ExpositorFerias');
		$this->addRelation('ExpositorLineaeditorial', 'ExpositorLineaeditorial', RelationMap::ONE_TO_MANY, array('id' => 'id_expositor', ), null, null, 'ExpositorLineaeditorials');
		$this->addRelation('PagoExpositor', 'PagoExpositor', RelationMap::ONE_TO_MANY, array('id' => 'id_expositor', ), null, null, 'PagoExpositors');
		$this->addRelation('Status', 'Status', RelationMap::ONE_TO_MANY, array('id' => 'id_expositor', ), null, null, 'Statuss');
	} // buildRelations()
