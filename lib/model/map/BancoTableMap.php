...
class BancoTableMap extends TableMap
{
	...
	public function buildRelations()
	{
		...
		$this->addRelation('Moneda', 'Moneda', RelationMap::MANY_TO_ONE, array('id_moneda' => 'id', ), null, null);
		$this->addRelation('Cuenta', 'Cuenta', RelationMap::ONE_TO_MANY, array('id' => 'id_banco', ), null, null, 'Cuentas');
		$this->addRelation('PagoExpositor', 'PagoExpositor', RelationMap::ONE_TO_MANY, array('id' => 'id_banco', ), null, null, 'PagoExpositors');
	} // buildRelations()
