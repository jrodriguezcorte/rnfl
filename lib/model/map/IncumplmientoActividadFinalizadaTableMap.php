...
class IncumplmientoActividadFinalizadaTableMap extends TableMap
{
	...
	public function buildRelations()
	{
		...
		$this->addRelation('ActividadFinalizada', 'ActividadFinalizada', RelationMap::MANY_TO_ONE, array('id_actividad_finalizada' => 'id', ), null, null);
		$this->addRelation('IncumplimientoActividad', 'IncumplimientoActividad', RelationMap::MANY_TO_ONE, array('id_incumplimiento_actividad' => 'id', ), null, null);
	} // buildRelations()
