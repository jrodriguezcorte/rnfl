...
class TipoActividadTableMap extends TableMap
{
	...
	{
		$this->addRelation('Actividad', 'Actividad', RelationMap::ONE_TO_MANY, array('id' => 'id_tipo_actividad', ), null, null, 'Actividads');
		$this->addRelation('ActividadTipoActividad', 'ActividadTipoActividad', RelationMap::ONE_TO_MANY, array('id' => 'id_tipo_actividad', ), null, null, 'ActividadTipoActividads');
	} // buildRelations()
