...
class TipoActividadTableMap extends TableMap
{
	...
	{
		$this->addRelation('Actividad', 'Actividad', RelationMap::ONE_TO_MANY, array('id' => 'id_tipo_actividad', ), 'CASCADE', null, 'Actividads');
		$this->addRelation('ActividadTipoActividad', 'ActividadTipoActividad', RelationMap::ONE_TO_MANY, array('id' => 'id_tipo_actividad', ), 'CASCADE', null, 'ActividadTipoActividads');
	} // buildRelations()
