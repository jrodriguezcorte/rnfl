...
class sfGuardGroupForm extends BasesfGuardGroupForm
{
  public function configure()
  {
    ...
    $this->widgetSchema['sf_guard_group_permission_list'] = new sfWidgetFormInputHidden();
    
    $this->widgetSchema->setLabel('name', 'Nombre <font color="red">*</font>');  
    
    $this->widgetSchema->setLabel('description', 'Descripción <font color="red">*</font>');  
